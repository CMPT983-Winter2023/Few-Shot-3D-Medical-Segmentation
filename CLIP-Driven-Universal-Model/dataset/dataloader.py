...
def get_loader(args):
    ...
    if args.phase == 'train_validation':
        ...
        return train_loader, train_sampler, val_loader, val_transforms
    ...
    if args.phase == 'validation':
        if args.cache_dataset:
            ...
            val_dataset = Dataset(data=data_dicts_val, transform=val_transforms)
        val_loader = DataLoader(val_dataset, batch_size=1, shuffle=False, num_workers=4, collate_fn=list_data_collate)
        return val_loader, val_transforms, None, None
    ...
    if args.phase == 'test':
        ...
        return test_loader, val_transforms, None, None
