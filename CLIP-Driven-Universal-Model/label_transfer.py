...
ORGAN_DATASET_DIR = 'dataset/'
#ORGAN_LIST = 'dataset/dataset_list/PAOT.txt'
ORGAN_LIST = 'dataset/dataset_list/PAOT_btcv_test.txt'
NUM_WORKER = 8
NUM_CLASS = 32
## full list
...
#TRANSFER_LIST = ['08']
TRANSFER_LIST = ['01']
#TRANSFER_LIST = ['01', '10_01', '10_02', '10_03', '10_04', '10_05', '10_06', '10_07', '10_08', '10_09', '10_10']
...
for index, batch in enumerate(train_loader):
    ...
    if os.path.exists(ORGAN_DATASET_DIR + batch['name'][0].replace('label', 'post_label') + '.h5'):
        print(batch['name'][0].replace('label', 'post_label'))
        continue
