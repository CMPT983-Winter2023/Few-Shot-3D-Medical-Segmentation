    ...
    for index, batch in enumerate(tqdm(ValLoader)):
        ...
        for b in range(B):
            ...
            for organ in organ_list:
                ...
                #print("\ndice_organ: ", dice_organ)
                #dice_list[template_key][0][organ-1] += dice_organ.item()
                dice_list[template_key][0][organ-1] += dice_organ[0].item()
...
def process(args):
    ...
    train_loader, train_sampler, validation_loader, val_transforms = get_loader(args)
    ...
    while args.epoch < args.max_epoch:
        ...
        if (args.epoch % args.store_num == 0 and args.epoch != 0) and rank == 0:
            ...
            torch.save(checkpoint, 'out/' + args.log_name + '/epoch_' + str(args.epoch+1) + '.pth')
            print('save model success')

        '''#if (args.epoch % args.val_num == 0 and args.epoch != 0) and rank == 0:
        if (args.epoch % args.val_num == 0) and rank == 0:
...
def main():
    ...
    ## logging
    parser.add_argument('--log_name', default='rand', help='The path resume from checkpoint')
    ## model load
    ...
    parser.add_argument('--val_num', default=50, type=int, help='Validate model how often')
    ...
    parser.add_argument('--dataset_list', nargs='+', default=['PAOT_spleen']) # 'PAOT', 'felix'
    ...
    parser.add_argument('--phase', default='train_validation', help='train or validation or test')
    ...
    #parser.add_argument('--datasetkey', nargs='+', default=['01', '10_03', 
    #                                        '10_06', '10_07', '10_08', '10_09', '10_10'],
    #                                        help='the content for ')
    #parser.add_argument('--datasetkey', nargs='+', default=['10_03', 
    #                                        '10_06', '10_07', '10_08', '10_10'],
    #                                        help='the content for ')
    parser.add_argument('--datasetkey', nargs='+', default=['10_09'],
                                            help='the content for ')
    parser.add_argument('--cache_dataset', action="store_true", default=False, help='whether use cache dataset')
    parser.add_argument('--cache_rate', default=0.005, type=float, help='The percentage of cached data in total')

    parser.add_argument('--attention', action="store_true", default=False, help='whether using attention or not')
