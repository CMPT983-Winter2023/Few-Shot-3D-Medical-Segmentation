...
def main():
    ...
    #parser.add_argument('--resume', default='./out/swinunetr/epoch_0.pth', help='The path resume from checkpoint')
    ...
    store_path_root = 'out/' + args.log_name + '/epoch_11.pth'
    ...
    test_loader, val_transforms, _, _ = get_loader(args)
